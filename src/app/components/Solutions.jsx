...
//this is the landing page solutions component
function Solutions({ data }) {
  if (!data || !data.solutions) return null;
            ...
            <div key={service.id} className="col py-4 my-2 my-sm-3">
              ...
              >
                <div className="card-body pt-3">
                  <div className="d-inline-block bg-primary shadow-primary rounded-3 position-absolute top-0 translate-middle-y p-3">
                    {service.serviceIcon?.url && (
                      <img
                        ...
                        alt={solution.solutionIcon.alternativeText || service.title}
                        width="55"
                  ...
                  <p className="fs-sm text-body mb-0">{solutioin.summary}</p>
                </div>
              </a>
            </div>
          ))}
