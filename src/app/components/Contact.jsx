...
const Contact = ({ data }) => {
 ...
 const mapWrapperStyle = {
  ...
  overflow: "hidden",
  minHeight: "340px",   // ← removed height: "100%"
  ...
  return (
    <section className="container" style={sectionStyle}>
      ...
      <div
        className="row py-3 align-items-stretch"
    ...
    `}</style>
        ...
        <div className="col-lg-5 offset-lg-1 d-flex flex-column justify-content-center">
          ...
          <ul className="list-unstyled mb-0">
            ...
            {phone && (
              <li style={infoItemStyle}>
                ...
                <a href={`tel:${phone}`} style={infoTextStyle}>
                  {phone}
                </a>
              </li>
            )}
            {email && (
              <li style={infoItemStyle}>
                ...
                <a href={`mailto:${email}`} style={infoTextStyle}>
                  {email}
                </a>
              </li>
            )}
          ...
          <div style={{ display: "flex", gap: "0.5rem", marginTop: "1.5rem" }}>
            <a
              href="https://www.linkedin.com/company/etqan-projects/"
              target="_blank"
              rel="noreferrer"
